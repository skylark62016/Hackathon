...
public class WriteExcel {
	    ...
	    int k=0;
		 File file=new File(Utils.readProperty("outputExcel"));
		 ...
		 if(!ReadExcel.data[6].split(" ")[1].equalsIgnoreCase("Jan")) {
			 tablerows++;
		 }
		...
		k=0;
		int year=Integer.parseInt(ReadExcel.data[6].split(" ")[0]);
		for(int i=1;i<=tablerows;i++) {
